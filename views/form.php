      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card bg-dark text-dark" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <div>
             <input type="checkbox" class="form-check-input" id="exampleCheck1" style="dark"> 
             <label class="form-check-label" for="exampleCheck1" style="color:dark">Check me out</label>
            </div>
